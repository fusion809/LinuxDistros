...
\begin{document}
	...
	\begin{tightcenter}
		{\LARGE Linux distributions}\\
	\end{tightcenter}
	  
	\begin{longtable}{|p{3.5cm}|p{2.3cm}|p{1.6cm}|p{2.4cm}|p{2.0cm}|p{14.7cm}|}
		\caption{Currently maintained Linux distributions}\\\hline
			...
			\multicolumn{6}{|c|}{\textbf{Independent}} \\\hline
			...
			\multicolumn{6}{|c|}{\textbf{Arch-based}} \\\hline
			Artix Linux & Pacman & Rolling & OpenRC, runit, s6 & 2017, Global & Meant to be a continuation of Arch-OpenRC and Manjaro-OpenRC projects and offers several editions with different user interfaces. \\\hline
			CachyOS & Pacman & Rolling & systemd & $\leq$2022, DE & Optimized for speed and security. Has command-line and graphical installers. \\\hline
			Ditana GNU/Linux & Pacman & Rolling & systemd & 2024, CH & Designed to be at an optimal position on the spectrum between customizability and user friendliness. Uses Xfce as default user interface.\\\hline
			EndeavourOS & Pacman & Rolling & systemd & 2019, NL & Aims to be spiritual successor to Antergos. \\\hline
			Manjaro & Pacman & Rolling & systemd & 2011, AT, DE, FR & Very popular Arch derivative, designed to be fairly easy to setup and use. Creates lovely artwork too. \\\hline
			Parabola GNU/Linux-libre & Pacman & Rolling & systemd, OpenRC & 2009, CL & FOSS version of Arch. \\\hline
			\multicolumn{6}{|c|}{\textbf{Debian-based}} \\\hline
			antiX & dpkg/APT & Fixed & SysV & 2007?, GR & Fast, lightweight and easy to install distro that can be run from RAM on a live medium. \\\hline
			deepin & dpkg/APT & Fixed & systemd & 2004, CN & Was once based on Ubuntu, but since 2015 has been based on Debian. Created its own desktop environment called Deepin Desktop Environment (DDE). \\\hline
			Devuan & dpkg/APT & Fixed & SysV, OpenRC \& runit & 2016, Global & Designed to be Debian without systemd. \\\hline
			elementary OS & dpkg/APT & Fixed & systemd & 2011, US & Based on Ubuntu. Has a macOS-like look and designed for beginners. \\\hline
			KDE neon & dpkg/APT & Fixed & systemd & 2016, UK & Based on Ubuntu LTS editions. Designed to feature the latest KDE Plasma 5. \\\hline
			...
			Nitrux & dpkg/APT & Fixed & OpenRC & 2017, MX & Based on unstable branch of Debian, with additional packages from Ubuntu LTS. Uses JWM and customized KDE Plasma desktop called NX Desktop.\\\hline
			Peppermint OS & dpkg/APT & Fixed & systemd, runit, SysV, OpenRC & 2010, UK & Designed to be lightweight, originally based on Lubuntu and now (since 2022) based on Debian (stable branch) and Devuan. \\\hline
			...
			AlmaLinux OS & RPM/dnf & Fixed & systemd & 2020, US & Rebuild of RHEL that is free. Essentially a replacement for what CentOS used to be. \\\hline
			CentOS & RPM/dnf & Semi-rolling & systemd & 2003, US & Originally, it was a free rebuild of Red Hat Enterprise Linux (RHEL). This version followed a fixed release model. Since 2020 this version has been discontinued. CentOS Stream now exists and is mid-stream between Fedora and RHEL. \\\hline
			...
			\multicolumn{6}{|c|}{\textbf{Gentoo-based}} \\\hline
			Calculate Linux & Portage & Rolling & OpenRC, SysV & 2007, RU & Has binary package updates, despite using Portage. Is a family of three distros: one is a server distro, another is a desktop featuring multiple different desktop environments, and a final that has a build framework for building a custom distribution.\\\hline
			Redcore Linux & Portage & Rolling & OpenRC & 2017, RO & Has a repository of pre-compiled binary packages to make setting up the system faster and easier. \\\hline
			\multicolumn{6}{|c|}{\textbf{Linux From Scratch-based}} \\\hline
			NuTyX & cards & Fixed & systemd, SysV & 2007, CH & Built from LFS and Beyond LFS with its own package manager cards that can work with both binary and source packages. The distro is designed for intermediate to more advanced users. \\\hline
